...
const useProduct = () => {
  const goals = useContext(ProductContext);
  if (goals == null) {
    throw new Error("useProduct() called outside of a ProductProvider?"); // an alert is not placed because this is an error for the developer not the user
  }
  return goals;
};
